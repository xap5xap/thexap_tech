...
| XAP-201 | Project discovery and technology instrumentation | Pending | Not started | Repository and browser evidence |
| XAP-202 | Upwork tagged-link and confirmed-outcome workflow | Pending | Not started | Synthetic URL and redirect checks; no proposal edits or sends |
